...
drop function if exists public.create_reservation_checkout(
  varchar, uuid, uuid, uuid, varchar, date, date, date, time, varchar,
  varchar, numeric, varchar, varchar, text, jsonb, jsonb
);
...
grant execute on function public.create_reservation_checkout(
  varchar, uuid, uuid, uuid, varchar, date, date, date, time, varchar,
  varchar, numeric, varchar, varchar, text, jsonb, jsonb, varchar, numeric
) to authenticated;
